...
export const EnvelopeIcon = () => (
  <svg id="svg-envelope-animate" width="30px" height="25px" viewBox="0 0 25 27" version="1.1">
    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g id="bottom-envelope">
        <path className="svg-envolope-color" id="mail-envelope-body" fill="#8D8D8D"
        ...
        <path id="mail-envelope-open" fill="#FFFFFF"
      ...
      <g id="paper" transform="translate(3.000000, 3.000000)">
        <path className="svg-envolope-color" id="paper-body" fill="#8D8D8D"
        ...
        <path id="paper-content" fill="#FFFFFF"
        ...
        <path className="svg-envolope-color" id="paper-lines" fill="#8D8D8D"
      ...
      <g id="upper-envelope" transform="translate(0.000000, 11.000000)">
        <path className="svg-envolope-color" id="TOP" fill="#8D8D8D"
