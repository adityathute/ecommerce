                    ...
                    <svg id="svg-envelope-animate" width="30px" height="25px" viewBox="0 0 25 27" version="1.1">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <g id="paper" transform="translate(3.000000, 3.000000)">
                                <path class="svg-envolope-color" id="paper-body" fill="#8D8D8D"
                                ...
                                <path class="svg-envolope-color" id="paper-lines" fill="#8D8D8D"
